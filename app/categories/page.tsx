...
const categories = [
  {
    ...
    name: 'Floral',
    description: 'Feminine and romantic fragrances with flower essences',
    image: 'https://readdy.ai/api/search-image?query=Beautiful%20blooming%20flowers...&width=400&height=300&seq=floral-category&orientation=landscape',
    productCount: 12,
    popularNotes: ['Rose', 'Jasmine', 'Peony', 'Lily of the Valley'],
    color: 'bg-pink-50 border-pink-200'
  },
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-gradient-to-r from-gray-900 to-gray-700 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Fragrance Categories</h1>
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Explore our carefully curated fragrance families. From romantic florals to mysterious orientals, find your perfect scent personality.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-20 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Find Your Signature Scent</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Not sure which category suits you? Take our fragrance quiz or explore our curated collections to discover your perfect match.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          {[{
            ...
            icon: 'ri-flask-line',
            desc: 'Answer a few questions to discover your perfect fragrance family',
            btn: 'Take Quiz',
            link: '#'
          }, {
            title: 'Bestsellers',
            icon: 'ri-heart-line',
            desc: 'Discover the most loved fragrances from each category',
            btn: 'View Bestsellers',
            link: '/products?sort=popular'
          }, {
            title: 'Gift Sets',
            icon: 'ri-gift-line',
            desc: 'Perfect fragrance combinations for special occasions',
            btn: 'Shop Gifts',
            link: '/gifts'
          }].map((card, i) => (
            <div key={i} className="text-center p-6 bg-gray-50 rounded-2xl">
              ...
              <Link href={card.link} className="text-gray-900 hover:text-gray-700 font-medium whitespace-nowrap">
                {card.btn}
                <div className="w-4 h-4 inline-flex items-center justify-center ml-1">
                  <i className="ri-arrow-right-line text-sm"></i>
                </div>
        ...
        <div className="mt-20 bg-gradient-to-r from-gray-900 to-gray-700 rounded-2xl p-8 md:p-12 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">Stay Updated on New Fragrances</h2>
          <p className="text-gray-200 mb-8 max-w-2xl mx-auto">
            Be the first to know about new releases, exclusive collections, and special offers from your favorite fragrance categories.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              type="email"
